...
import 'package:quality_management_system/Features/OrderTableDetails/view_model/order_collected/order_collected_cubit.dart';


class OrdersTableDetailsCollected extends StatefulWidget {
  const OrdersTableDetailsCollected({super.key});

  @override
  State<OrdersTableDetailsCollected> createState() => _OrdersTableDetailsCollectedState();
}

class _OrdersTableDetailsCollectedState extends State<OrdersTableDetailsCollected> {
  ...
  Widget _buildOrderTable(bool isDesktop) {
    return BlocProvider(
      create: (context) => OrderCollectedCubit(), // استدعاء دالة تحميل الطلبات المعلقة فقط
      child: BlocConsumer<OrderCollectedCubit, OrderCollectedState>(
                ...
                DataColumn(
                  ...
                  onSort: (columnIndex, ascending) {
                    setState(() {
                      ...
                      OrderCollectedCubit.get(context).sortOrders<String>(
                        _sortedOrders,
                ...
                DataColumn(
                  ...
                  onSort: (columnIndex, ascending) {
                    setState(() {
                      _sortColumnIndex = columnIndex;
                      _sortAscending = ascending;
                      OrderCollectedCubit.get(context).sortOrders<num>(
                        _sortedOrders,
