...
import 'package:quality_management_system/Features/OrderTableDetails/view_model/order_complete/order_complete_cubit.dart';


class OrdersTableDetailsCompleted extends StatefulWidget {
  const OrdersTableDetailsCompleted({super.key});

  @override
  State<OrdersTableDetailsCompleted> createState() => _OrdersTableDetailsCompletedState();
}

class _OrdersTableDetailsCompletedState extends State<OrdersTableDetailsCompleted> {
  ...
  Widget _buildOrderTable(bool isDesktop) {
    return BlocProvider(
      create: (context) => OrderCompleteCubit(), // استدعاء دالة تحميل الطلبات المعلقة فقط
                ...
                DataColumn(
                  ...
                  onSort: (columnIndex, ascending) {
                    setState(() {
                      ...
                      OrderCompleteCubit.get(context).sortOrders<String>(
                        _sortedOrders,
                ...
                DataColumn(
                  ...
                  onSort: (columnIndex, ascending) {
                    setState(() {
                      _sortColumnIndex = columnIndex;
                      _sortAscending = ascending;
                      OrderCompleteCubit.get(context).sortOrders<num>(
                        _sortedOrders,
