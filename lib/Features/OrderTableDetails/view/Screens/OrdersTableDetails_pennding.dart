...
import 'package:quality_management_system/Features/OrderTableDetails/view_model/order_filter/order_filter_cubit.dart';


class OrdersTableDetailsPending extends StatefulWidget {
  const OrdersTableDetailsPending({super.key});

  @override
  State<OrdersTableDetailsPending> createState() => _OrdersTableDetailsPendingState();
}

class _OrdersTableDetailsPendingState extends State<OrdersTableDetailsPending> {
  ...
  Widget _buildOrderTable(bool isDesktop) {
    return BlocProvider(
      create: (context) => OrderFilterCubit(), // استدعاء دالة تحميل الطلبات المعلقة فقط
                ...
                DataColumn(
                  ...
                  onSort: (columnIndex, ascending) {
                    setState(() {
                      ...
                      OrderFilterCubit.get(context).sortOrders<String>(
                        _sortedOrders,
                ...
                DataColumn(
                  ...
                  onSort: (columnIndex, ascending) {
                    setState(() {
                      _sortColumnIndex = columnIndex;
                      _sortAscending = ascending;
                      OrderFilterCubit.get(context).sortOrders<num>(
                        _sortedOrders,
